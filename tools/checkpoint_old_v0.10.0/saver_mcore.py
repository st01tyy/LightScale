...
def save_checkpoint(queue, args):
    ...
    md = queue_get()
    # print("=================== md")
    # print(md.attention_dropout)
    # print(md.hidden_dropout)
    ...
    sys.argv = ['script.py',
                ...
                '--tokenizer-model', str(md.tokenizer_model) if str(md.tokenizer_type) == "HuggingFaceTokenizer" else None,
    ...
    if margs.tokenizer_type != "HuggingFaceTokenizer":
        margs.tokenizer_model = None
        print("setting tokenizer_model to None")
    ...
    margs = get_args()
    print("===================")
    print(margs.attention_dropout)
    print(margs.hidden_dropout)
