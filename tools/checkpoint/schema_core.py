...
class CoreTESchema(CoreSchema):
    ...
    def __init__(self, model_type, prefix, extra_layer_schema):
        super().__init__(model_type, layer_schema={
            ...
            # MLA specific
            "self_attn_mla_q_down_weight": "self_attention.linear_q_down_proj.weight",
            "self_attn_mla_q_up_weight": "self_attention.linear_q_up_proj.weight",
            "self_attn_mla_q_norm_weight": "self_attention.linear_q_up_proj.layer_norm_weight",
            "self_attn_mla_q_proj_weight": "self_attention.linear_q_proj.weight",
            "self_attn_mla_kv_down_weight": "self_attention.linear_kv_down_proj.weight",
            "self_attn_mla_kv_up_weight": "self_attention.linear_kv_up_proj.weight",
            "self_attn_mla_kv_norm_weight": "self_attention.linear_kv_up_proj.layer_norm_weight",

            "self_attn_q_norm": "self_attention.q_layernorm.weight",
            "self_attn_k_norm": "self_attention.k_layernorm.weight",
...
class CoreTEMixSchema(CoreSchema):

    def __init__(self, model_type, prefix, extra_layer_schema, num_experts, expert_model_parallel_size):
        ...
        super().__init__(model_type, layer_schema={
            ...
            "mlp_norm_weight" : "mlp.linear_fc1.layer_norm_weight",
            "mlp_norm_bias" : "mlp.linear_fc1.layer_norm_bias",
            "moe_mlp_norm_weight": "pre_mlp_layernorm.weight",
            "mlp_fc1_weight" : "mlp.linear_fc1.weight",
            "mlp_fc1_bias" : "mlp.linear_fc1.bias",
            "mlp_fc2_weight" : "mlp.linear_fc2.weight",
            "mlp_fc2_bias" : "mlp.linear_fc2.bias",
            ...
            # Shared experts
            "shared_experts_fc1_weight": "mlp.shared_experts.linear_fc1.weight",
            "shared_experts_fc2_weight": "mlp.shared_experts.linear_fc2.weight",
            "shared_experts_gate_weight": "mlp.shared_experts.gate_weight",
...
class CoreMoETEGroupGEMMSchema(CoreSchema):
...
def get_model_schema(
    ...
    if num_experts is not None and num_experts > 0:
        ...
        return CoreTEMixSchema(model_type, prefix, extra_layer_schema, num_experts, expert_model_parallel_size)
    return {
