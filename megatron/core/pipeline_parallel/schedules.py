...
def forward_step(
    ...
    vp_stage=None,
    global_num_microbatches: Optional[int] = None,
):
    ...
    if hasattr(config, 'num_moe_experts') and config.num_moe_experts is not None:
        ...
        if config.calculate_per_token_loss:
            ...
            if global_num_microbatches is not None:
                MoEAuxLossAutoScaler.set_loss_scale(loss_scale / global_num_microbatches)
            else:
    ...
    if hasattr(config, 'mtp_num_layers') and config.mtp_num_layers is not None:
        ...
        if config.calculate_per_token_loss:
            ...
            if global_num_microbatches is not None:
                MTPLossAutoScaler.set_loss_scale(loss_scale / global_num_microbatches)
            else:
