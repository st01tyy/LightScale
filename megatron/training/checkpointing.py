...
def load_args_from_checkpoint(
    ...
    # Transformer structural args that impact rotary/MLA behaviors.
    _set_arg('norm_epsilon', force=True)
    _set_arg('rope_type', force=False)
    _set_arg('rotary_scaling_factor', force=False)
    _set_arg('mscale', force=False)
    _set_arg('mscale_all_dim', force=False)
    _set_arg('beta_fast', force=False)
    _set_arg('beta_slow', force=False)
    ...
    _set_arg('moe_router_pre_softmax', force=False)
    ...
    _set_arg('moe_router_dtype', force=False)
    _set_arg('moe_router_score_function', force=True)
    _set_arg('moe_router_num_groups', force=True)
    _set_arg('moe_router_group_topk', force=True)
    _set_arg('moe_router_topk_scaling_factor', force=True)
    _set_arg('moe_router_enable_expert_bias', force=True)
    _set_arg('moe_router_bias_update_rate', force=False)
    _set_arg('moe_aux_loss_coeff', force=False)
